...
class SignupPasswordPage extends Component<Props, State> {
...
const options: ExplicitConnectOptions<{||}, StateProps, DispatchProps> = {
  ...
  mapDispatchToProps: dispatch => ({
    ...
    onSubmit: async (password: string) => {
      await dispatch(setSignupPassword(password));
...
export const SignupPasswordPageContainer = explicitConnect(options);
